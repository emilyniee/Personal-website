...
export default function Wip() {
  return (
    <aside className="w-full flex justify-center fixed px-12 pb-1 pt-1 bg-coffee-100" role="banner">
      <p className="text-sm text-coffee-300">
        ...
        <a
          ...
          className="text-sm text-coffee-300 underline hover:text-coffee-400 ml-1"
